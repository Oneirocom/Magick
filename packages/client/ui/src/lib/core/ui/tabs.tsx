...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'inline-flex h-9 items-center justify-center rounded-sm bg-ds-neutral p-1 text-white/60',
      className
    )}
    {...props}
  />
