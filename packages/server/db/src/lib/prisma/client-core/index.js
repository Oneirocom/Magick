...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/Users/parzival/workspace/oneirocom/Magick/packages/server/db/src/lib/prisma/client-core",
      "fromEnvVar": null
    },
    "config": {
      "name": "prisma",
...
path.join(process.cwd(), "src/lib/prisma/client-core/libquery_engine-darwin-arm64.dylib.node")

// file annotations for bundling tools to include these files
path.join(__dirname, "libquery_engine-linux-musl-openssl-3.0.x.so.node");
path.join(process.cwd(), "src/lib/prisma/client-core/libquery_engine-linux-musl-openssl-3.0.x.so.node")
// file annotations for bundling tools to include these files
