...
const config = {
  generator: {
    ...
    output: {
      value:
        '/Users/jakobgrant/Workspaces/Oneirocom/Magick/packages/server/db/src/lib/prisma/client-core',
      fromEnvVar: null,
    },
    config: {
      name: 'prisma',
  ...
  inlineSchemaHash:
    '0ec05c5b405bc818c278c60706c9b145d3a9e739792d63b4e924eef51a4a49a3',
  copyEngine: true,
}
...
path.join(
  process.cwd(),
  'src/lib/prisma/client-core/libquery_engine-debian-openssl-1.1.x.so.node'
)
...
path.join(
  process.cwd(),
  'src/lib/prisma/client-core/libquery_engine-linux-musl-openssl-3.0.x.so.node'
)
// file annotations for bundling tools to include these files
