...
const config = {
  generator: {
    ...
    output: {
      value:
        '/Users/jakobgrant/Workspaces/Oneirocom/test/Magick/packages/server/db/src/lib/prisma/client-core',
      fromEnvVar: null,
    },
    config: {
      name: 'prisma',
