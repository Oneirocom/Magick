...
path.join(
  process.cwd(),
  'src/lib/prisma/client-core/libquery_engine-debian-openssl-3.0.x.so.node'
)
// file annotations for bundling tools to include these files
