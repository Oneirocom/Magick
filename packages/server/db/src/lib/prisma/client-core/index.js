...
const config = {
  generator: {
    ...
    output: {
      value:
        '/Users/parzival/workspace/oneirocom/Magick/packages/server/db/src/lib/prisma/client-core',
      fromEnvVar: null,
    },
    config: {
      name: 'prisma',
...
path.join(
  process.cwd(),
  'src/lib/prisma/client-core/libquery_engine-darwin-arm64.dylib.node'
)
