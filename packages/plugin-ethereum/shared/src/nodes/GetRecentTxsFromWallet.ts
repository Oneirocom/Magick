 ...
 *
 * @remarks
 * This component extends the MagickComponent class from the @magickml/engine module and has an async worker method.
 *
...
export class GetRecentTxsFromWallet extends MagickComponent<Promise<InputReturn>> {
   ...
   *
   * @param node - Required by the worker and uses the WorkerData type from the @magickml/engine module.
   * @param inputs - Required by the worker and uses the MagickWorkerInputs type from the @magickml/engine module.
   * @param outputs - Required by the worker and uses the MagickWorkerOutputs type from the @magickml/engine module.
