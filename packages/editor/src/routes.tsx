...
/**
 * RenderComp function component.
 * @param {object} props - Props for custom element.
 * @returns {JSX.Element} The custom element with passed props.
 */
...
/**
 * MyRoutes function component that holds all routes for the application.
 * @returns {JSX.Element} Routes wrapped with `Routes` component.
 */
const MyRoutes = () => (
  <Routes>
