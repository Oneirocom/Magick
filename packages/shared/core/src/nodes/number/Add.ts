...
const info = `Takes two numbers as input and adds them together.`
 ...
 */
export class Add extends MagickComponent<WorkerOutputs> {
  constructor() {
    super(
      'Add',
      {
  ...
  /**
   * Build the node for the Add component
  ...
  /**
   * Worker function to execute the Add functionality
