...
const info = `Evaluate whether an input number is equal to the value. Triggers true if it is, false if it isn't.`

/**
 * Equal Class represents a component that checks if a given number is within a specified range.
 */
export class Equal extends MagickComponent<void> {
  constructor() {
    super(
      'Equal',
      {
