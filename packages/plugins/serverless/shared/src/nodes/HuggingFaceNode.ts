...
/**
 * HuggingFaceNode component responsible for making inference with a Hugging Face model.
 */
export class HuggingFaceNode extends MagickComponent<Promise<WorkerReturn>> {
  constructor() {
    super(
      'Hugging Face',
      {
