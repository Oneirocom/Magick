...
const fewshot = `Why are you talking like this?,Please don't be mean`
...
export class RandomProfanityResponse extends ThothComponent<
  Promise<WorkerReturn>
> {
  constructor() {
    super('Random Profanity Response')
