...
function getVarForEnvironment(env: string): string | undefined {
  return (
    ...
    processEnv[`VITE_${env}`] || // Check VITE prefixed env variables
...
export const SPEECH_SERVER_URL = getVarForEnvironment('SPEECH_SERVER_URL') || 'http://localhost:65532';
export const TRUSTED_PARENT_URL = getVarForEnvironment('TRUSTED_PARENT_URL') || 'http://localhost:3000';
export const UNTRUSTED_IFRAME = getVarForEnvironment('UNTRUSTED_IFRAME') || false;
