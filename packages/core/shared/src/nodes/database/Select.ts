...
/** Information related to the Select */
const info =
...
/**
 * Select component responsible for selecting records using any providers
 * available in Magick.
 */
export class Select extends MagickComponent<Promise<WorkerReturn>> {
  constructor() {
    super(
      'Select Record',
      {
  ...
  builder(node: MagickNode) {
    ...
    /**
     * Configure the provided node according to the selected database provider.
     */
    const configureNode = () => {
  ...
  /**
   * Worker for processing select queries.
