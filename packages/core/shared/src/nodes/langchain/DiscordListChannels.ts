 ...
 */
export class DiscordListChannels extends MagickComponent<Promise<WorkerReturn>> {

    constructor() {
        super('Discord List Channels', {
            outputs: {
                output: 'output',
                trigger: 'option',
            },
        }, 'Langchain', 'Gets the List of All channels in a server');
    }
