...
/** Information related to the SpeechToText */
const info =
...
/**
 * SpeechToText component responsible for generating text using any providers
 * available in Magick.
 */
export class SpeechToText extends MagickComponent<Promise<WorkerReturn>> {
  constructor() {
    super(
      'SpeechToText',
      {
