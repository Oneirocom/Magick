...
export class Alert extends MagickComponent<void> {
  constructor() {
     ...
     */
    super('Alert', {outputs: {}}, 'Utility', `When the alert component is triggered, it will fire an alert with the message in the input box.`);
  }
  ...
  builder(node: MagickNode): MagickNode {
    ...
    const value = typeof node.data.text === 'string' ? node.data.text : 'Input text here';
