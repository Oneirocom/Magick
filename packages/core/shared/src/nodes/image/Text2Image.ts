...
/** Information related to the Text2Image */
...
/**
 * Text2Image component responsible for generating text using any providers
 * available in Magick.
 */
export class Text2Image extends MagickComponent<Promise<WorkerReturn>> {
  constructor() {
    super(
      'Text2Image',
      {
