...
/** Information related to the ImageToImage */
...
/**
 * ImageToImage component responsible for generating text using any providers
 * available in Magick.
 */
export class ImageToImage extends MagickComponent<Promise<WorkerReturn>> {
  constructor() {
    super(
      'ImageToImage',
      {
