import { ILogger, NodeCategory } from '@magickml/behave-graph'
import { CoreLLMService } from '../../services/coreLLMService/coreLLMService'
import { CORE_DEP_KEYS } from '../../config'
import { IEventStore, makeMagickAsyncNodeDefinition } from 'server/grimoire'
import {
  CompletionModel,
...
export const generateTextAsync = makeMagickAsyncNodeDefinition({
  typeName: 'magick/generateTextAsync',
  category: NodeCategory.Action,
  label: 'Generate Text Async',
  configuration: {
    modelProviders: {
      valueType: 'array',
      defaultValue: [],
