 ...
 */
export class GetCalendar extends MagickComponent<Promise<WorkerReturn>> {
  /**
   * Constructor for GetCalendar component.
   */
  constructor() {
    super(
      'Get Calendar',
  ...
  async worker(
    ...
    const url = `${API_ROOT_URL}/google-gcal?query=${inputs.query[0]}`
