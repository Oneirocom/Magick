...
> {
  constructor() {
    super(
      ...
      'Discord',
      'Gets the List of All voice channels in a server'
    )
  }
  ...
  async worker(node: WorkerData): Promise<WorkerReturn> {
    const tool_desc = {
      ...
      keyword:
        'Discord voice channels, get audio channels, server audio channels, voice channels, server voice channels, fetch audio channels, get audio channels from server.',
    }
