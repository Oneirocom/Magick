...
const text2ImageCompletionControls = [
  // {
  //   type: InputControl,
  //   dataKey: 'prompt',
  //   name: 'Prompt',
...
// Input controls for dolly completion
const dollyCompletionControls = [
  {
    type: InputControl,
    dataKey: 'do_sample',
    name: 'Do Sample',
...
const flanCompletionControls = []

const pix2PixCompletionControls = [
  {
    type: InputControl,
    dataKey: 'image_url',
    name: 'Image URL',
