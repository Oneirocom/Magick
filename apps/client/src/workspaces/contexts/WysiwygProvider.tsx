...
type WysiwygContext = {
  ...
  textEditorData: WysiwygEditorData | null
  saveTextEditor: Function
  saveInspector: Function
}

const Context = createContext<WysiwygContext>(undefined!)

export const useWysiwygInspector = () => useContext(Context)

const WysiwygProvider = ({ children, tab }) => {
  ...
  const publicInterface: WysiwygContext = {
    inspectorData,
    textEditorData,
    saveTextEditor,
    saveInspector,
