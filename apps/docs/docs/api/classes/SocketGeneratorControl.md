---
id: "SocketGeneratorControl"
title: "Class: SocketGeneratorControl"
sidebar_label: "SocketGeneratorControl"
sidebar_position: 0
...
• **new SocketGeneratorControl**(`options`)
...
| :------ | :------ | :------ |
| `options` | `Object` | The options needed to generate the socket control. |
| `options.connectionType` | ``"output"`` \| ``"input"`` | The type of the connection of the socket generated. Can be 'input' or 'output'. |
| `options.icon?` | `string` | The icon for the SocketGeneratorControl. |
| `options.ignored?` | [`IgnoredList`](../#ignoredlist) | A list of items to be ignored. |
| `options.name` | `string` | The name of the socket generated. |
| `options.socketType?` | [`SocketType`](../#sockettype) | The socket type of the socket generated. |
| `options.taskType?` | [`TaskType`](../#tasktype) | The task type of the socket generated. |
...
[packages/core/shared/src/dataControls/SocketGenerator.ts:27](https://github.com/Oneirocom/Magick/blob/c560ff45/packages/core/shared/src/dataControls/SocketGenerator.ts#L27)
...
[packages/core/shared/src/dataControls/SocketGenerator.ts:14](https://github.com/Oneirocom/Magick/blob/c560ff45/packages/core/shared/src/dataControls/SocketGenerator.ts#L14)
