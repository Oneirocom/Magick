---
id: "engine_src.MagickEditor"
title: "Class: MagickEditor"
sidebar_label: "engine/src.MagickEditor"
custom_edit_url: null
---

[engine/src](../modules/engine_src.md).MagickEditor

## Hierarchy

- `NodeEditor`<[`EventsTypes`](../modules/engine_src.md#eventstypes)\>
...
• **magick**: [`EditorContext`](../interfaces/engine_src.EditorContext.md)
...
• **moduleManager**: [`ModuleManager`](engine_src.ModuleManager.md)
...
• **pubSub**: [`PubSubContext`](../interfaces/engine_src.PubSubContext.md)
...
| :------ | :------ |
| `names` | `K` \| `K`[] |
| `handler` | (`args`: `EventsTypes` & [`EventsTypes`](../modules/engine_src.md#eventstypes) & `EventsTypes`[`K`]) => `unknown` |
...
| :------ | :------ |
| `name` | `K` |
| `params?` | {} \| `EventsTypes` & [`EventsTypes`](../modules/engine_src.md#eventstypes) & `EventsTypes`[`K`] |
